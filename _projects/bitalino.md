...
<p>
  <a href="https://pub.dev/packages/bitalino">
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="https://raw.githubusercontent.com/Afonsocraposo/bitalino/master/doc/images/work-flow.png" title="Workflow scheme" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
